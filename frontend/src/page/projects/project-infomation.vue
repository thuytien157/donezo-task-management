                ...
                <form class="col-12" @submit.prevent="editProjectById(projectId)">
                    ...
                    <div class="task-info-grid mb-4">
                        <div class="task-info-row">
                            ...
                            <select disabled class="form-select" v-model="project.is_group_project">
                        ...
                        <div class="task-info-row">
                            ...
                            <div class="task-info-value d-flex align-items-center">
                                <input type="date" class="form-control" v-model="project.start_date" :min="today"
                                    disabled />
                            </div>
                            <small class="text-danger" v-if="
                        ...
                        <div class="task-info-row">
                            ...
                            <div class="task-info-value d-flex align-items-center">
                                <input type="date" class="form-control" v-model="project.end_date" :min="today"
                                    disabled />
                            </div>
                            <small class="text-danger" v-if="errors && errors.end_date && errors.end_date.length > 0">
                                {{ errors.end_date[0] }}
                            </small>
                        </div>
                        <div class="task-info-row">
                    ...
                    <button class="btn create-btn" type="submit">Sửa</button>
                </form>
            </div>
        </main>
    </div>
...
export default {
    ...
    setup(props) {
        ...
        onMounted(async () => {
            await getProjectById(props.projectId);
        });
        return {
            quillRef,
            editProjectById,
